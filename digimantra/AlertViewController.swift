...
class AlertViewController: UIViewController {
    ...
    private struct customIdentifier {
        static let cellClassIdentifier = "AlertCell"
        static let cellReuseIdentifier = "AlertCell"
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier(customIdentifier.cellReuseIdentifier, forIndexPath: indexPath) as! AlertCell
        return cell
    }
